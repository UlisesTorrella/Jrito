...
public class AggregatedStats {
    ...
    public String toString() {
        return "AggregatedStats [averageAssists=" + averageAssists
                ...
                + averageTeamObjective + ", averageTotalPlayerScore="
                + averageTotalPlayerScore + ", botGamesPlayed="
                + botGamesPlayed + ", killingSpree=" + killingSpree
                + ", maxAssists=" + maxAssists + ", maxChampionsKilled="
                + maxChampionsKilled + ", maxCombatPlayerScore="
                + maxCombatPlayerScore + ", maxLargestCriticalStrike="
                + maxLargestCriticalStrike + ", maxLargestKillingSpree="
                + maxLargestKillingSpree + ", maxNodeCapture=" + maxNodeCapture
                ...
                + ", maxTeamObjective=" + maxTeamObjective + ", maxTimePlayed="
                + maxTimePlayed + ", maxTimeSpentLiving=" + maxTimeSpentLiving
